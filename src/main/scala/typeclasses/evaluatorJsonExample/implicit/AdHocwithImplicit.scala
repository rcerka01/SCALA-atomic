...
object JsonOutput {
  ...
  def write[A](value: A)(implicit converter: JsonConverter[A]): String = write(converter.convertToJson(value))
...
// Typeclass (- Minus, Plus, Number are subclasses of Expression)
